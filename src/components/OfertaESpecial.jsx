...
export default function OfertaESpecial() {
    return (
        ...
        <div
            ...
            <div className="text-ofep mt-6 md:mt-0 md:ml-8 lg:ml-12 w-full md:w-1/2 lg:w-2/3 text-center md:text-left">
                <h2 className="ofep-h2 text-xl md:text-2xl lg:text-3xl font-bold text-gray-800">Oferta Especial</h2>
                ...
                <a href="#"
                    className="ofep-bt inline-block mt-6 bg-blue-500 text-white font-semibold py-2 px-4 rounded hover:bg-blue-600 transition duration-300">Ver
                    Oferta</a>
            </div>
        </div>
